...
utils.pprint(new_delta.days,'new_delta.days')
...
birth=dt.datatime(1999,1,4,hours=11,minutes=45)
now=dt.datetime.now()
alive=now-birth

utils.pprint(alive,'alive')
utils.pprint(alive.seconds,'alive.second')

secs=(alive.days*24*60*60)+alive.seconds
msg=f'I have been alive for {secs:,.of}'
#utils.pprint(msg)
